function x=MBSS_roomsimove_apply(time,HH,s,fs)
...
% s: 1 x s_length vector containing the signal to be filtered
% fs: sampling frequency in Hz
%
% Output:
% x: channels x s_length matrix containing the filtered signals
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
